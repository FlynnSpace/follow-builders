...
function buildSystemPrompt(data) {
  ...
  return [
    ...
    '',
    'CRITICAL — FORMATTING: Output PLAIN TEXT only. Do NOT use any Markdown syntax (no **, ##, *, ```, [], () etc). Use emoji for visual hierarchy instead:',
    '- Use 📡 for the X/Twitter section header',
    '- Use 🎙 for the Podcasts section header',
    '- Use ▸ before each builder name',
    '- Use 🔗 before links',
    '- Use 📌 for key takeaways',
    '- Use ━━━ as section dividers',
    '- Use line breaks for structure, not Markdown headers',
    '',
    `CRITICAL — OUTPUT LANGUAGE: ${langDirective}`,
    '',
    'CRITICAL — DIGEST STRUCTURE:',
    'The digest MUST start with a "⚡ 今日速览" (Quick Glance) section at the very top.',
    'This section lists EVERY builder who has content today, each with a ONE sentence summary (max 15 characters in Chinese) of their most notable point.',
    'Format example:',
    '⚡ 今日速览',
    '━━━',
    '▸ Aaron Levie — 企业 AI agent 正全面取代聊天机器人',
    '▸ Guillermo Rauch — Next.js 16.2 发布',
    '▸ Andrej Karpathy — 回忆 Jensen 2015 年的远见',
    '▸ 播客: StarCloud — 太空数据中心比地面更便宜',
    '━━━',
    '',
    'After the quick glance section, output the full detailed digest with individual summaries.',
    'The quick glance helps the reader decide which sections to read in detail below.',
    '',
